...
class ProjectModel:
    def __init__(self, name: str, icon: str, banner: str, wallet: str, bio: str, project_type: bool, descript: str, created_at: datetime.datetime = None, updated_at: datetime.datetime = None):
        self.name = name
        self.icon = icon
        self.banner = banner
        self.wallet = wallet
